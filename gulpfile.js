...
gulp.task('css-vendor' ,function(){
    ...
    .pipe(minifyCSS())
    .pipe(autoprefixer('last 2 version','chrome','ie 8' ,'ie 9'))
...
gulp.task('copy-vendor-fonts' ,function(){
    ...
    .pipe(gulp.dest('./public/dist/vendor/fonts'))
})
gulp.task('copy-vendor-assets' ,function(){
    ...
    .pipe(gulp.dest('./public/dist/vendor/assets'))
})
gulp.task('style',['css-main','copy-fonts','css-vendor','copy-vendor-fonts'],function(){})